...
1. You can inquire upcoming concerts by any artist name, genre, city, or specific time.
Example inputs: "Taylor Swift", "Rap", "Taipei", "Tomorrow"

2. You can also specify multiple criteria simultaneously.
Example inputs: "Taylor Swift concerts in Taipei", "Post Malone, next month", "Hip-Hop, this week, and in Tainan city"

3. You can also start by entering any keyword, and add more keywords based on the number of search results, . 
We will continue searching with the existing keywords to find relevant results and present them to you.

4. Further more, you can inquire which concerts are going to start selling the tickets.
Example inputs: "Find out which concerts are open for sale tomorrow", "Ticketing time, today and tomorrow"

5. You can reply to a concert message and type in e.g. "30 mins", "1 hour", "1 day and 1 hour and 30 mins".
The chatbot will send a message before the  
Have Fun!
            """
...
6. 如果聊天室閒置30分鐘，聊天室將會重置您目前的搜尋。但是聊天機器人並不會特別發出消息提醒您目前的搜尋已經重置。
