...
# chiense
json_file = 'artist_western.json'
waiting_artists = 'western_sorted_waiting.txt'
finished_artists = 'western_sorted_finished.txt'
...
with sync_playwright() as p:
    ...
    while True:
        try:
            start_url = "https://en.wikipedia.org/wiki/Post_Malone"
