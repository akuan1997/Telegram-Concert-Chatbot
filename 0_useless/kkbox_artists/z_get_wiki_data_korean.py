...
# chiense
json_file = 'artist_korean.json'
waiting_artists = 'korean_sorted_waiting.txt'
finished_artists = 'korean_sorted_finished.txt'
...
def get_wiki_data1(current_url, singer_name):
    # 先判斷這個網頁有沒有造訪過
    with open('z_visited_urls.txt', 'r', encoding='utf-8') as f:
        visited_urls = f.readlines()
