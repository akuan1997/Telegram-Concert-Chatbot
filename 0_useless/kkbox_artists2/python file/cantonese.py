...
# cantonese
language = '粵語'
json_file = '../cantonese.json'
waiting_artists = 'cantonese_waiting.txt'
finished_artists = 'cantonese_z.txt'
problem_file1 = 'cantonese_problem1.txt'  # 名稱對不起來
problem_file2 = 'cantonese_problem2.txt'  # 不是wikipedia
link_file = '../links/cantonese_link.txt'
