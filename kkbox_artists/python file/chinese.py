...
# chinese
language = '歌手'
json_file = '../chinese.json'
waiting_artists = 'chinese_waiting.txt'
finished_artists = 'chinese_z.txt'
problem_file1 = 'chinese_problem1.txt'  # 名稱對不起來
problem_file2 = 'chinese_problem2.txt'  # 不是wikipedia
link_file = '../links/chinese_link.txt'
