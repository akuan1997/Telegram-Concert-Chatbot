...
while True:
    ...
    get_keyword_indexes_en(user_input, "concert_en.json")
# while True:
#     time.sleep(5)
#     # 使用範例
#     directory_path = r"C:\Users\pfii1\akuan\git-repos\2024_Concert_Chatbot\en_concert_jsons"
#
#     # latest_json_file = get_latest_json_filename(directory_path)
#     # print(f"最新的 JSON 檔案是: {latest_json_file}")
#     # zh_en(zh_json, en_json)
#     # shutil.copy("123.py", f"en_concert_jsons/456.py")
#     shutil.copy(en_json, f"en_concert_jsons/{concert_today}")
