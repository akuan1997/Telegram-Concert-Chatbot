def current_one():
    # 首先讀取a.txt的所有數據
    with open('0_useless/z_test2_a.txt', 'r', encoding='utf-8') as f:
        a_datas = f.readlines()
    ...
    for i, a_data in enumerate(a_datas):
        ...
        # 寫入數據到b.txt
        with open('0_useless/z_test2_b.txt', 'a', encoding='utf-8') as f:
            f.write(a_data + '\n')

        # 更新a.txt：寫入還沒處理的數據
        with open('0_useless/z_test2_a.txt', 'w', encoding='utf-8') as f:
        ...
        with open('0_useless/z_test2_b.txt', 'r', encoding='utf-8') as f:
