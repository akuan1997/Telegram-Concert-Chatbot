...
ltp = LTP()  # Initialize the LTP model


def chinese_tokenizer_ltp(text):
    seg, _ = ltp.seg([text])
    return seg[0]
...
# 創建TF-IDF向量器，使用中文分詞
vectorizer = TfidfVectorizer(tokenizer=chinese_tokenizer_ltp, min_df=2, max_df=0.5, ngram_range=(1, 2))
