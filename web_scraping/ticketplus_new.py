            ...
            try:
                ...
                for i in range(last_finished_index + 1, all_event_numbers):
                    ...
                    if i < 6:
                        ...
                        while not page_ticketplus.locator(".row > div.d-flex.col-sm-6.col-md-4.col-12").nth(
                                i).is_visible():
                            page_ticketplus.keyboard.press('End')
                    ...
                    for j in range(len(columns)):
                        column_text = page_ticketplus.locator("#buyTicket > .sesstion-item").nth(j).locator(
                            "div > div > div").nth(
                            0).inner_text()
